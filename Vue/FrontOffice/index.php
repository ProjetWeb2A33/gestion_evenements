  ...
  <main class="main">
        ...
        <div class="row gy-4 d-flex justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <form action="#" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
              <input type="text" class="form-control" placeholder="Entrer Votre Position">
          ...
          <div class="col-lg-6 content order-last  order-lg-first" data-aos="fade-up" data-aos-delay="100">
            ...
            <ul>
              <li>
                ...
                <div>
                  <h5>Innovation</h5>
                  <p>Asteria se distingue par sa capacité à proposer des idées originales et à concevoir des solutions modernes adaptées aux besoins actuels, en intégrant des technologies avancées et des approches créatives.</p>
                </div>
              </li>
              <li>
                ...
                <div>
                  ...
                  <p>Les membres du groupe travaillent en parfaite synergie, favorisant un environnement collaboratif où l'écoute, le respect et le soutien mutuel permettent d’atteindre les objectifs communs avec efficacité.</p>
                </div>
              </li>
              <li>
                ...
                <div>
                  <h5>Polyvalence</h5>
                  <p>Grâce à la diversité des compétences au sein du groupe, Asteria sait s’adapter à différents domaines – qu’il s’agisse de développement logiciel, de gestion de projet ou de communication – en garantissant des résultats solides et cohérents.</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/parking.avif" alt="" class="img-fluid">
              </div>
              <h3>Parking</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/event.png" alt="" class="img-fluid">
              </div>
              <h3><a href="#" class="stretched-link">Événement</a></h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/vacance.webp"alt="" class="img-fluid">
              </div>
              <h3><a href="#" class="stretched-link">Vacances</a></h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/service.jpeg"alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/covoiturage.jpg" alt="" class="img-fluid">
              </div>
              <h3>Covoiturage</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="card">
              <div class="card-img">
                <img src="assets/image/fidelite.png"alt="" class="img-fluid">
              </div>
              <h3><a href="#" class="stretched-link">Être fidèle</a></h3>
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              ...
              <a class="cta-btn" href="#">Contacter nous!</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>C’est bien plus qu’un simple outil de réservation. C’est une plateforme intelligente conçue pour faciliter votre quotidien.</p>
      </div><!-- End Section Title -->
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="col-md-5 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
            <img src="assets/image/trouverplace.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            <h3>Trouver une place facilement</h3>
            <p class="fst-italic">
              Localisez en temps réel les parkings disponibles autour de vous, en quelques clics.
            </p>
            <ul>
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/image/reserver.avif" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="col-md-5 d-flex align-items-center" data-aos="zoom-out">
            <img src="assets/image/covoiturage.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out">
            <img src="assets/image/compteutilisateur.avif" class="img-fluid" alt="">
          </div>
