...
<head>
  ...
  <title>EasyParki - Ajouter Evenement</title>
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0">
      <div class="mx-3">
        <a class="btn btn-outline-white mt-4 w-100" href="C:\xampp2\htdocs\ProjetWeb2A33\Vue\FrontOffice\evenement.php">FrontOffice</a>
      </div>
    </div>
  </aside>
      ...
      <div class="form-container">
        ...
        <form method="POST" onsubmit="return validateForm()">
          ...
          <div class="mb-3">
            ...
            <span id="error-date" class="error-message"></span>
          </div>
          
          <div class="mb-3">
            <label class="form-label">Lieu:</label>
            <input type="text" class="form-control" name="lieu">
            <span id="error-lieu" class="error-message"></span>
          </div>
          
          <div class="mb-3">
            <label class="form-label">Nombre Place Restante:</label>
            <input type="number" class="form-control" name="nbrPlace_restante">
            <span id="error-lieu" class="error-message"></span>
          </div>
          
          <div class="mb-3">
            <label class="form-label">Nombre Place Occupée:</label>
